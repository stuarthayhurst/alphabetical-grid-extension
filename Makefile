...
build:
	...
	$(MAKE) package
package:
	gnome-extensions pack --force --podir=po --extra-source=LICENSE.txt --extra-source=docs/CHANGELOG.md --extra-source=docs/icon.svg --extra-source=ui/prefs.ui --extra-source=ui/prefs-gtk4.ui --extra-source=lib
check:
